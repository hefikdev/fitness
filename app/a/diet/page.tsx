...
import { Clock, Flame, Beef, Wheat } from "lucide-react";
...
function RecipeGrid({ mealType }: { mealType: MealType }) {
  const { data, isPending } = trpc.diet.list.useQuery({ mealType });
